...
public class Picture_adapter extends  RecyclerView.Adapter<Picture_adapter.ViewHolder> {
    ...
    //构造
    public Picture_adapter(List<Picture> mList) {
        this.mList = mList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //绑定行布局
        View view = View.inflate(parent.getContext(), R.layout.layout_imageview,null);
        //实例化ViewHolder
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            //绑定控件
            img=(ImageView) itemView.findViewById(R.id.item_image1);
